...
//        }
    ...
    public function deletekonfig_rekap($id_konfig)
    {
        $delete = DB::table('konfigurasi_berita')->where('id_konfig', $id_konfig)->delete();
        if ($delete) {
            return redirect()->route('konfig.konfigrekapberita')->with(['success'=>'Konfigurasi Rekap Berita Berhasil Dihapus']);
            //return Redirect::back()->with(['success' => 'Konfigurasi Berita Berhasil Dihapus']);
        } else {
            return redirect()->route('konfig.konfigrekapberita')->with(['warning'=>'Konfigurasi Rekap Berita Gagal Dihapus']);
