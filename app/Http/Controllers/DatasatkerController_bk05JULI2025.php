...
//                ->get();
            ...
            if (sizeof($dtBerita) > 0) {
                ...
                $text = $section->addText($dtKonfig->nama_kakanwil, $secondtStyle);
                $text = $section->addText('');
                $text = $section->addText("PEMBATAS============================================================PEMBATAS", $secondtStyle);
                ...
                //berita dari website kanwil disable sementara DARI SINI
...
//                    $text = $section->addText("");
//                }
                //berita dari website kanwil disable sementara SAMPAI SINI
